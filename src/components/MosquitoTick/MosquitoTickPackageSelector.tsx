  ...
  const lookupProperty = useCallback(async (fullAddress: string) => {
    ...
    try {
      ...
      if (data.found && data.lotSizeAcres) {
        ...
        // No lot data — show manual fallback
  ...
  return (
    <>
      <div className="max-w-2xl mx-auto space-y-6">
        {/* ─── Address Lookup ─── */}
        <div className="relative rounded-3xl border-2 border-green-500/30 bg-card p-8 md:p-10 shadow-[0_0_40px_rgba(34,197,94,0.08)]" style={{ boxShadow: "var(--card-shadow), 0 0 40px rgba(34,197,94,0.08)" }}>
          {/* Step badge */}
          ...
          {/* Property matched — show checkmark */}
          <AnimatePresence>
            {resolvedSize && propertyResult?.found && (
              ...
              >
                <div className="rounded-2xl border border-green-500/25 bg-gradient-to-br from-green-500/10 to-emerald-500/5 p-6 text-center">
                  ...
                  >
                    Here&apos;s your personalized quote below.
                  </motion.p>
                </div>
              </motion.div>
            )}
              ...
              >
                <div className="rounded-2xl border border-amber-500/25 bg-amber-500/5 p-5">
                  <p className="text-amber-300 text-sm font-medium mb-1">
                    We couldn&apos;t find your property in our records.
                  </p>
                  <p className="text-white/50 text-sm">
                    No worries — select your yard size below for a quote.
                  </p>
                </div>
              </motion.div>
            )}
        ...
        {/* ─── Personalized Quote (only after address lookup) ─── */}
        <AnimatePresence>
          {hasResult && finalPkg && (
            <motion.div
            ...
            >
              {/* Manual size selector (only if no auto-detect) */}
              {showManualFallback && (
              ...
              <div className="glass-card rounded-3xl border border-green-500/20 bg-gradient-to-br from-green-500/5 to-emerald-500/3 p-6 md:p-8">
                ...
                {finalPkg.quoteOnly ? (
                  <>
                    ...
                    <a
                      href={quoteHref}
                      className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-green-500 px-5 py-4 text-base font-display font-bold text-white transition-all hover:bg-green-400 hover:shadow-[0_0_30px_rgba(34,197,94,0.3)]"
                    >
                  ...
                  <>
                    ...
                    <div className="rounded-2xl border border-white/10 bg-white/5 p-5 mb-5">
                      ...
                      <ul className="space-y-2 text-sm text-white/70">
                        <li className="flex items-start gap-2.5">
                          ...
                          Exterior perimeter of your home
                        </li>
                        <li className="flex items-start gap-2.5">
                          <CheckCircle2 size={14} className="mt-0.5 shrink-0 text-green-400" />
                        ...
                        <li className="flex items-start gap-2.5">
                          <CheckCircle2 size={14} className="mt-0.5 shrink-0 text-green-400" />
                          High-traffic zones your family frequents
                        </li>
                        <li className="flex items-start gap-2.5">
                          <CheckCircle2 size={14} className="mt-0.5 shrink-0 text-green-400" />
                          Areas of concern flagged by you
                        </li>
                      </ul>
                      <p className="text-xs text-white/35 mt-3">
                        We treat up to 1 acre of active areas. This is mosquito <em>reduction</em> — designed to make your yard enjoyable again.
                      </p>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-3 mb-6">
                      {[
                        ...
                        <span
                          key={item}
                          className="inline-flex items-center gap-1.5 text-xs font-semibold text-white/60 bg-white/5 border border-white/10 rounded-full px-3 py-1.5"
                        >
                    ...
                    <button
                      ...
                      className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-green-500 px-5 py-4 text-base font-display font-bold text-white transition-all hover:bg-green-400 hover:shadow-[0_0_30px_rgba(34,197,94,0.3)] group"
                    >
                    ...
                    <a
                      href={helpHref}
                      className="mt-3 inline-flex w-full items-center justify-center gap-2 rounded-2xl border border-white/10 bg-white/5 px-5 py-3 text-sm font-display font-bold text-white/60 transition-colors hover:border-green-500/40 hover:bg-white/10 hover:text-white"
                    >
      ...
      {/* Cross-sell modal: offer General Pest when booking M&T */}
      <CrossSellModal
