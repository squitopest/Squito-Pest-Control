...
const pests = [
  ...
  { image: "/pests/pest_wasp.png", name: "Wasps", risk: "Medium", season: "Late Summer to Early Fall", tip: "As summer ends, wasp colonies reach their maximum size and become highly aggressive while scavenging for sugary foods. Attempting to remove a nest without professional equipment can result in severe, dangerous swarming. Our technicians safely neutralize active, high-elevation nests and utilize preventative treatments along rooflines to stop them from returning the following year." },
