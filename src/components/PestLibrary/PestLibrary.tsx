...
import { Search, X, Camera, ShieldAlert, ArrowRight, Loader2, AlertTriangle } from "lucide-react";
...
export default function PestLibrary() {
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      // Compress image to reduce cost and upload size
  ...
  const compressAndEncode = (file: File): Promise<string> => {
    return new Promise((resolve, reject) => {
      ...
      img.onload = () => {
        ...
        // Resize to max 512px on longest side for cost efficiency
        const maxDim = 512;
        ...
        <div className="flex flex-col items-center text-center mb-16 animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 w-full max-w-lg">
            ...
            >
              ...
              />
              <span className="relative flex items-center justify-center gap-2 w-full px-5 py-3 rounded-xl bg-background/90 backdrop-blur-xl font-semibold text-sm text-white transition-all duration-300 group-hover:bg-green-500/10 whitespace-nowrap">
                  ...
                  {aiResult.identified ? (
                    <>
                      ...
                      <div className="flex flex-col sm:flex-row gap-3">
                        ...
                        <a href="#contact" className="flex-1 inline-flex items-center justify-center gap-2 px-5 py-3 bg-white/5 border border-white/10 hover:border-green-500/50 hover:bg-green-500/10 text-white font-semibold rounded-xl transition-all text-sm">
                          Get Free Inspection
                        </a>
                      </div>
                    </>
