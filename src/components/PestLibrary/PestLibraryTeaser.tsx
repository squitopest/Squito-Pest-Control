            ...
            {teaserPests.map(pest => {
              ...
              return (
                ...
                >
                  ...
                  />
                  {/* Keep just a soft bottom-to-top dark gradient so the pest
                      name stays legible over bright photo areas. No more
                      global dim or green-multiply wash — photos read full
                      color now. */}
