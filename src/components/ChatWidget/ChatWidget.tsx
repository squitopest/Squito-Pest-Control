...
import { MessageCircle, X, Send, Phone, Shield, Loader2 } from "lucide-react";
...
export default function ChatWidget() {
  ...
  return (
    <>
      ...
      {open && (
        <div className="fixed bottom-24 right-4 sm:right-6 w-[calc(100vw-32px)] sm:w-[380px] h-[550px] max-h-[calc(100vh-120px)] bg-background/95 backdrop-blur-xl border border-border shadow-2xl rounded-2xl z-[9900] flex flex-col overflow-hidden animate-fade-in-up">
